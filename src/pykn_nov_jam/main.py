...
# wall2 = EntityPrefabs.create_static_object(kn.Vec2(100, 300), 32, 256)
# entities.add_entity(wall2)
# wall3 = EntityPrefabs.create_static_object(kn.Vec2(400, 300), 32, 256)
# entities.add_entity(wall3)
#
# for i in range(5):
